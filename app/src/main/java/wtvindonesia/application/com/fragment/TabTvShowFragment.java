...
public class TabTvShowFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View rootView = inflater.inflate(R.layout.fragment_tab_tv_show, container, false);
        ...
        scrollListener = new EndlessRecyclerViewScrollListener(linearLayoutManager) {
            ...
            public void onLoadMore(int page, int totalItemsCount, RecyclerView view) {
                ...
                ((MainActivity) getActivity()).loadDataTvShow(false);
            }
        };
        ...
        recyclerView.addOnItemTouchListener(new RecyclerViewOnClickListener(getActivity().getApplicationContext(), new RecyclerViewOnClickListener.OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                ...
                ((MainActivity) getActivity()).openDetailVideo(MainActivity.tvshowlist.get(position).getVideoId());
        ...
        swipeRefresh.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                ...
                ((MainActivity) getActivity()).loadDataTvShow(true);
            }
        });
